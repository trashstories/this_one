...
vars2_tbl %>% 
  ...
  cols_label(x = md("")) %>% 
  cols_width(x ~ pct(40),
             contains("health fac") ~ pct(19),
             contains("inpatient care") ~ pct(19),
...
MDsum %>%
  ...
  cols_label(Variable = md(""),
             ...
             Min = md("*Min*"),
             Max = md("*Max*")) %>% 
  cols_width(Variable ~ pct(45),
             starts_with("M") ~ pct(10),
             Std.Dev ~ pct(10))
...
MDw %>% 
  ...
  cols_label(FIPS = md("*FIPS Code*"),
             ...
             pctBlack = md("*% Black*")) %>% 
  cols_width(Imprisonment_Rate ~ pct(15)) %>% 
  cols_align(align = "center")
